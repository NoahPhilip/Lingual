...
@NLP.route('/lingual', methods=['GET', 'POST'])
def lingual():
    if request.method == 'POST':
        input_text = request.form['text']
        modified_grammer = "Grammar: " + check_grammar(input_text)
        modifed_cliches = "Use of Cliches: " + check_cliches(input_text)
        voice = "Voice: " + is_passive_voice(input_text)
        repWords = "Frequent Words: " + count_repeated_words(input_text)
        return render_template('lingual.html', modified_text=modified_grammer, modified_textt=voice, modified_texttt=modifed_cliches, modified_textttt=repWords)
    else:
